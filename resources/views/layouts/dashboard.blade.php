...
<!-- Mirrored from www.wrraptheme.com/templates/alpino/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Aug 2021 16:36:51 GMT -->
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" href="/user-dashboard/assets/plugins/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" href="/user-dashboard/assets/plugins/morrisjs/morris.css" />
<link rel="stylesheet" href="/user-dashboard/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.css"/>
<!-- Custom Css -->
<link rel="stylesheet" href="/user-dashboard/assets/css/main.css">
<link rel="stylesheet" href="/user-dashboard/assets/css/color_skins.css">
</head>
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="/user-dashboard/assets/images/logo.svg" width="48" height="48" alt="Alpino"></div>
        <p>Please wait...</p>        
    </div>
</div>
...
<aside id="minileftbar" class="minileftbar">
    <ul class="menu_list">
        <li>
            ...
            <a class="navbar-brand" href="index.html"><img src="/user-dashboard/assets/images/logo.svg" alt="Alpino"></a>
        </li>
        {{--  
        for overlay_menu class
                ...
                <div class="body">
                    <ul class="messages list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="/user-dashboard/assets/images/xs/avatar1.jpg" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="/user-dashboard/assets/images/xs/avatar2.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="/user-dashboard/assets/images/xs/avatar3.jpg" alt="">
                                    <div class="media-body">
                ...
                <div class="body m-b-10">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            ...
                            <li><img src="/user-dashboard/assets/images/xs/avatar2.jpg" alt="Avatar"></li>
                            <li><img src="/user-dashboard/assets/images/xs/avatar3.jpg" alt="Avatar"></li>
                            <li><img src="/user-dashboard/assets/images/xs/avatar4.jpg" alt="Avatar"></li>
                        </ul>
                    </a>
                </div>
                <div class="body m-b-10">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-r-15"><small class="text-muted">Team</small></li>
                            <li><img src="/user-dashboard/assets/images/xs/avatar6.jpg" alt="Avatar"></li>
                            <li><img src="/user-dashboard/assets/images/xs/avatar7.jpg" alt="Avatar"></li>
                        </ul>
                    </a>
                </div>
                <div class="body">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-r-15"><small class="text-muted">Team</small></li>
                            <li><img src="/user-dashboard/assets/images/xs/avatar8.jpg" alt="Avatar"></li>
                            <li><img src="/user-dashboard/assets/images/xs/avatar9.jpg" alt="Avatar"></li>
                        </ul>
                    </a>
                </div>
            </div>
            ...
            <ul class="list">
                <li>
                    <div class="user-info m-b-20">
                        <div class="image">
                            <a href="profile.html"><img src="/user-dashboard/assets/images/profile_av.jpg" alt="User"></a>
                        </div>
                        <div class="detail">
                            <h6>Michael</h6>
...
<!-- Jquery Core Js -->
<script src="/user-dashboard/assets/bundles/libscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js ( jquery.v3.2.1, Bootstrap4 js) -->
<script src="/user-dashboard/assets/bundles/vendorscripts.bundle.js"></script> <!-- slimscroll, waves Scripts Plugin Js -->

<script src="/user-dashboard/assets/bundles/knob.bundle.js"></script> <!-- Jquery Knob-->
<script src="/user-dashboard/assets/bundles/jvectormap.bundle.js"></script> <!-- JVectorMap Plugin Js -->
<script src="/user-dashboard/assets/bundles/morrisscripts.bundle.js"></script> <!-- Morris Plugin Js --> 
<script src="/user-dashboard/assets/bundles/sparkline.bundle.js"></script> <!-- sparkline Plugin Js --> 
<script src="/user-dashboard/assets/bundles/doughnut.bundle.js"></script>

<script src="/user-dashboard/assets/bundles/mainscripts.bundle.js"></script>
<script src="/user-dashboard/assets/js/pages/index.js"></script>
</body>

<!-- Mirrored from www.wrraptheme.com/templates/alpino/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Aug 2021 16:37:45 GMT -->
</html>